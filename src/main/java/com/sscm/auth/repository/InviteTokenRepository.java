...
public interface InviteTokenRepository extends JpaRepository<InviteToken, Long> {
    ...
    @Query("""
            ...
            """)
    Optional<InviteToken> findActiveToken(String phone, OtpPurpose purpose, Instant now);
    ...
    @Query("""
            ...
            WHERE it.phone = :phone
              ...
              AND it.usedAt IS NULL
            """)
    int invalidateAll(String phone, OtpPurpose purpose, Instant now);
    ...
    @Query("""
            ...
            WHERE it.phone = :phone
              AND it.purpose = :purpose
            """)
    Optional<Instant> findLatestCreatedAt(String phone, OtpPurpose purpose);
}
